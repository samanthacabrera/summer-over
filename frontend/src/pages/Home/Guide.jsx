    ...
    <section id="guide">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between space-y-8 md:space-y-0 md:space-x-8">
          <div className="p-8 rounded-lg border-current border-8 shadow-lg hover:shadow-xl hover:bg-white hover:bg-opacity-30 transition-all duration-300">
        ...
        <div className="p-8 mt-8 rounded-lg border-current border-8 shadow-lg hover:shadow-xl hover:bg-white hover:bg-opacity-30 transition-all duration-300">
