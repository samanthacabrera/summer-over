    ...
    <section id="guide">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between space-y-8 md:space-y-0 md:space-x-8">
          <div className="p-8 rounded-lg border-current border-4 shadow-md hover:shadow-xl transition-all duration-300 flex-1 min-h-[150px] flex flex-col justify-between">
            <div>
              <h3 className="text-xl font-semibold mb-4">Join & Setup</h3>
              <p>Create an account and enable location access to start exploring local swap listings.</p>
            </div>
          </div>
          <div className="p-8 rounded-lg border-current border-4 shadow-md hover:shadow-xl transition-all duration-300 flex-1 min-h-[150px] flex flex-col justify-between">
            <div>
              <h3 className="text-xl font-semibold mb-4">Explore & Offer</h3>
              <p>When you see an item you like, you can offer an item of yours to swap.</p>
            </div>
          </div>
          <div className="p-8 rounded-lg border-current border-4 shadow-md hover:shadow-xl transition-all duration-300 flex-1 min-h-[150px] flex flex-col justify-between">
            <div>
              <h3 className="text-xl font-semibold mb-4">Meet & Swap</h3>
